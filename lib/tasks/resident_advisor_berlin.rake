...
namespace :resident_advisor_berlin do
  task list: :environment do
    ...
    html_file = open("https://www.residentadvisor.net/events.aspx?ai=34&v=day&mn=#{current_month}&yr=#{current_year}&dy=#{current_day}")
...
# rake resident_advisor_berlin:list
# noglob rake resident_advisor_berlin:import[862446] in the square brackets u have to put an event id
